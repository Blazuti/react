...
export default function body(){
    return(
        <main>
            <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, harum blanditiis. Aspernatur beatae repellendus sint! Quasi libero id amet culpa laboriosam molestias quos ipsum reiciendis! Voluptatum pariatur accusamus odio ab!
                <br/>
